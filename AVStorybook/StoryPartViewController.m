...
- (void)viewDidLoad {
    ...
    self.audioRecorder = [[AVAudioRecorder alloc] initWithURL:self.thisPageModel.audioFileURL settings:self.recordSetting error:NULL];
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    if(self.thisPageModel.image){
        self.imageView.image = self.thisPageModel.image;
...
- (IBAction)showImagePicker:(id)sender {
    ...
    NSLog(@"tapped image button, starting image picker");
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *,id> *)info {
    ...
    if (image) {
        self.thisPageModel.image = image;
    }
...
- (IBAction)tappedImage:(id)sender {
    ...
    NSLog(@"tapped image, starting audio playback");
